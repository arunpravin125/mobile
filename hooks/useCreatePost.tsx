...
export const useCreatePost = () => {
    ...
    const createPostMutation = useMutation({
        mutationFn: async (postData: { content: string, imageUri?: string }) => {
            ...
            if (postData.imageUri) {
                ...
                formData.append("image", { uri: postData.imageUri, name: `image.${fileType}`, type: mimeType } as any)
            };
    ...
    return {
        content, setContent, selectedImage, isCreating: createPostMutation.isPending, pickImageFromGallery: () => handleImagePicker(false),
